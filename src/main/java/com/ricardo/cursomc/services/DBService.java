...
public class DBService {
    ...
    public void instantiateTestDataBGase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "ricardo.rodrigues.alves@hotmail.com", "36978912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ana Costa", "riktodopoderoso@gmail.com", "36978912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
        cli2.addPerfil(Perfil.ADMIN);
        cli2.getTelefones().addAll(Arrays.asList("27363350", "93838396"));


        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Jundiai", "154", "comercial", "JD Florida", "38777012", cli2, c2);
